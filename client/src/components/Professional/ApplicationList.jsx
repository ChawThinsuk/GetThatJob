...
export const ApplicationList = () => {
  ...
  const handleDeclined = async (jobId) => {
    ...
    try {
      await axios.put(
        `http://localhost:4000/ta2/users/${state.userID}/jobs/${jobId}`
      );
      getApplyJob();
      toast({
          ...
          {isLoading ? (
            ...
            fillteredData.map((item) => (
              ...
              >
                ...
                />
                <div className=" flex w-[55.6625rem] justify-between items-center ">
                  <div className=" flex w-[170px] items-center gap-[1.1rem]">
                    <img
                      src={item.logo}
                      alt={item.logo}
