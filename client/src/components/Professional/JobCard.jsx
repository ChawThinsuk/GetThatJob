    ...
    >
      {isLoading ? (
        ...
        <div className="w-[345px] h-[195px] flex flex-col justify-between items-center relative">
          <div className="flex absolute bottom-[52.5px] left-[-19px] font-[Montserrat] rounded-xl text-yellow-400 font-semibold">
            {index < 3 && page === 1 && paidAmount > 0 && (
              <div
                title="Save"
                className=" flex items-center fill-pink-300   rounded-md duration-100 p-2"
              >
                <svg
                  viewBox="0 -0.5 25 25"
                  height="20px"
                ...
                <span className="text-sm text-pink-300 font-bold pr-1">
                  Recommend
                </span>
              </div>
            )}
            ...
            <div className="flex pl-2 flex-col w-[230px] h-[110px]">
              <div className="flex flex-row gap-[5px]">
                ...
                <p className="text-[16px] text-[#8E8E8E] min-w-[142px] h-[22px] font-[Inter] font-[400]">
                  ...
                  <span
                    className={`${job.job_category.length < 21 && "hidden"}`}
                  >
                    ...
                  </span>
                </p>
              ...
              <div className="flex flex-col w-[230px] h-[86px]">
                <p className="text-[22px] text-[#373737] w-[270px] h-[32px] font-[Montserrat] font-[500]">
                  {job.job_title.slice(0, 16)}
                  <span className={`${job.job_title.length < 17 && "hidden"}`}>
                    ...
                  </span>
                </p>
