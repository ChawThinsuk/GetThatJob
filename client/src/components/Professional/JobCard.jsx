    ...
    >
      {isLoading ? (
        ...
        <div className='w-[345px] h-[195px] flex flex-col justify-between items-center relative'>
             <div className='flex absolute bottom-[52.5px] left-[-19px] font-[Montserrat] rounded-xl text-yellow-400 font-semibold'>{index < 3 && page===1 && <div title="Save" class=" flex items-center fill-pink-300   rounded-md duration-100 p-2">
