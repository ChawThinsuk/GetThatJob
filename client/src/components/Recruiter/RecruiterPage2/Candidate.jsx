...
function Candidate(props) {
  ...
  return (
      <div
       ...
       >
        <div className="flex flex-row h-[79px] justify-between items-center">
          <div className="ml-[16px]">
            <p className="text-[20px] font-[Montserrat] font-medium">
              Guybrush Threepwood
            </p>
            <div className="flex flex-row text-[14px] text-[#616161] gap-2 ">
              <svg
                width="18"
                height="19"
                viewBox="0 0 18 19"
          ...
          <div className="flex flex-col justify-center items-start">
            <div className="flex flex-row items-center text-center gap-2 text-[#8E8E8E] text-[12px]">
              <svg
                width="16"
                height="15"
                viewBox="0 0 16 10"
          ...
          <div className="flex flex-col items-center text-[#8E8E8E] text-[12px]">
            <svg
              width="16"
              height="15"
              viewBox="0 0 16 15"
          ...
          <div className="flex flex-col items-center text-[#F48FB1] text-[12px] leading-[18px]">
            <svg
              width="16"
              height="15"
              viewBox="0 0 16 15"
          ...
          <div className="flex flex-row items-center gap-2">
            <button className="text-[#616161] text-[18.66px] w-[240px] h-[53.33px] border-[1px] border-[#F48FB1] rounded-[21.33px]">
              MARK AS STARTED
            </button>
            <div
        ...
        <div className="overflow-hidden max-h-0 group-[.is-active]:max-h-[600px] duration-500 ml-[16px] mb">
          <div className="mt-[16px] duration-500">
          ...
          <div className="flex justify-center items-center mt-[16px] mb-[16px]">
            <button className="flex flex-row gap-2 w-[183px] h-[40px] items-center justify-center border-[1px] border-[#F48FB1] rounded-[16px] text-[#616161]">
              <svg
                width="25"
                height="24"
                viewBox="0 0 25 24"
